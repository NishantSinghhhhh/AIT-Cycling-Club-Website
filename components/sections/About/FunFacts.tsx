...
export default function FunFacts() {
  return (
    <section className="w-full px-[10%] pt-16 pb-8">
      <h1 className="text-gray-100 text-5xl font-extrabold flex justify-center items-center gap-2 mb-10">
        <span className="text-gray-100 text-5xl">&ldquo;</span>
        Some{" "}
        <span className="text-red-600 underline decoration-red-600">
          Fun Facts
        </span>{" "}
        About Us
        <span className="text-gray-100 text-5xl">&rdquo;</span>
      </h1>
