...
export default function Credentials() {
  return (
    <section className="w-full bg-black py-24 px-2 md:px-16 overflow-hidden">
      <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-16 gap-4 px-2 md:px-0">
        <h2
